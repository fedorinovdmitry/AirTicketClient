...
@implementation NotificationCenter
    ...
    -(void)sendNotification:(Notification)notification{
        if(@available(iOS 10.0, *)){
            ...
            UILocalNotification *localNotifacation = [[UILocalNotification alloc]init];
            localNotifacation.fireDate = notification.date;
            if(notification.title){
                localNotifacation.alertBody = [NSString stringWithFormat:@"%@ - %@", notification.title, notification.body];
            }else{
                localNotifacation.alertBody = notification.body;
            }
